...
--     warn(" This script must only be executed from the offical sr7 loader")
--         return
--     end
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading Sr7...")
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Sr7") then
			makefolder("Sr7");
		end;
		if not isfolder("Sr7/Blox Fruits/") then
			makefolder("Sr7/Blox Fruits/");
		end;
		if not isfile(("Sr7/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Sr7/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Sr7/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("Sr7/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("Sr7/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
